...
`dist/session-1761563587642-k7gsffxdm/` ディレクトリに統合して出力してください。
...
# 出力先
`dist/session-1761563587642-k7gsffxdm/` （例: `dist/gaia-llc/`）
...
# 入力ファイル
@dist/session-1761563587642-k7gsffxdm/business_info.md

# 出力先
dist/session-1761563587642-k7gsffxdm/
