...
`dist/session-1761556157002-4xb9rr1xg/` ディレクトリに統合して出力してください。
...
# 出力先
`dist/session-1761556157002-4xb9rr1xg/` （例: `dist/gaia-llc/`）
...
# 入力ファイル
@dist/session-1761556157002-4xb9rr1xg/business_info.md

# 出力先
dist/session-1761556157002-4xb9rr1xg/
