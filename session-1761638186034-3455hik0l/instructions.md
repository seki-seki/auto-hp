...
`dist/session-1761638186034-3455hik0l/` ディレクトリに統合して出力してください。
...
# 出力先
`dist/session-1761638186034-3455hik0l/` （例: `dist/gaia-llc/`）
...
# 入力ファイル
@dist/session-1761638186034-3455hik0l/business_info.md

# 出力先
dist/session-1761638186034-3455hik0l/
