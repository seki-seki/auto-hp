...
`dist/session-1761553444777-7yvaqyb9v/` ディレクトリに統合して出力してください。
...
# 出力先
`dist/session-1761553444777-7yvaqyb9v/` （例: `dist/gaia-llc/`）
...
# 入力ファイル
@dist/session-1761553444777-7yvaqyb9v/business_info.md

# 出力先
dist/session-1761553444777-7yvaqyb9v/
