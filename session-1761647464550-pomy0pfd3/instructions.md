...
`dist/session-1761647464550-pomy0pfd3/` ディレクトリに統合して出力してください。
...
# 出力先
`dist/session-1761647464550-pomy0pfd3/` （例: `dist/gaia-llc/`）
...
# 入力ファイル
@dist/session-1761647464550-pomy0pfd3/business_info.md

# 出力先
dist/session-1761647464550-pomy0pfd3/
