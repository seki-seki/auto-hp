...
`dist/session-1761563346071-k7me09xqx/` ディレクトリに統合して出力してください。
...
# 出力先
`dist/session-1761563346071-k7me09xqx/` （例: `dist/gaia-llc/`）
...
# 入力ファイル
@dist/session-1761563346071-k7me09xqx/business_info.md

# 出力先
dist/session-1761563346071-k7me09xqx/
