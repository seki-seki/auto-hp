...
const remainingSites = [
  ...
  { name: "熊本空港レンタカー", url: "https://kumamoto-rentacar.jp/", filename: "kumamoto-rentacar" },
  { name: "空港前保育園", url: "https://kukomae-hoikuen.com/", filename: "kukomae-hoikuen" },
  { name: "医療法人徳治会 インプラントサイト", url: "https://www.motoki-implant.com/", filename: "motoki-implant" },
  { name: "株式会社海神", url: "https://kks-wadatsumi.com/", filename: "kks-wadatsumi" },
  { name: "安岐グループ", url: "https://yasuki-group.co.jp/", filename: "yasuki-group" },
  { name: "元木歯科予防サイト", url: "https://www.motoki-dental-prevention.com/", filename: "motoki-dental-prevention" },
  { name: "株式会社フードチャネル", url: "https://food-ch.co.jp/", filename: "food-ch" },
